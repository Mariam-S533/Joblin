...
function CompanyPostsComp({companyPosts}: {companyPosts: JobPost[]}) {
    ...
    const totalPages = Math.ceil(companyPosts.length / jobsPerPage)
    const startIndex = (currentPage - 1) * jobsPerPage
    const endIndex = startIndex + jobsPerPage
    const currentJobs = companyPosts.slice(startIndex, endIndex)
     ...
     <div className="lg:container md:w-[85%] w-[90%] mx-auto">
      <div className="">
          ...
          <div className="flex flex-col mx-auto items-center justify-center gap-3 mb-8">
            <h1 className=' font-semibold text-joblin-black lg:text-[32px] text-[28px] '>Discover the Company Jobs</h1>
                      ...
                      <div key={post.id} className="p-6  rounded-md border border-[#EDEDED]">
                          <div className="flex items-start justify-between gap-4">
                                <div className="w-12 h-12 rounded-md overflow-hidden flex items-center justify-center">
                                    <Image src={post.companyLogoUrl || "/icons/comany.png"} alt="company logo" width={40} height={40} unoptimized />
                                </div>
                                <div className="flex flex-col gap-2 w-full">
                                    ...
                                    <div className="flex items-center justify-between font-medium ">
                                      ...
                                      <div className=" text-joblin-primary flex  md:items-center text-[14px] gap-2 cursor-pointer font-medium"> 
                                        <Link  href={`/find-job/${post.id}`} className=" text-joblin-primary flex items-center text-[14px] gap-2 cursor-pointer font-medium">
