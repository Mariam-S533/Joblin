          ...
          <div className='grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 md:grid-cols-2 gap-10 md:gap-5 px-4 py-10 '>
              ...
              <div className='col-span-1 space-y-4'>
                    ...
                    <p className=' text-sm mt-2 text-gray-500 '>
                      Joblin is a smart job search and recruitment platform
                      that connects job seekers with employers. With fast
                      search, professional resume building, and intelligent
                      matching, Jablin makes hiring and job hunting easy
                      and efficient.</p>
              </div>
              <div className=' space-y-4  px-2'>
                ...
                <ul className=' space-y-2 '>
                  {FOOTER_LINKS.services.map((service, index) => (
                    <li key={index} className=' text-sm text-gray-500 hover:text-gray-800 cursor-pointer '>
                      <Link href="#">
                      {service}
                      </Link>
                    </li>
              ...
              <div className=' space-y-4 px-2 '>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <span><Link href="#"><i className="fa-brands fa-instagram"/></Link></span>
                  <span><Link href="#"><i className="fa-brands fa-whatsapp"/></Link></span>
                  </div>
                <p className=' flex items-center text-[15px] mb-1 gap-1'> <MapPin size={15} /><span>123 Main Street, Anytown, USA</span></p>
                <p className=' flex items-center text-[15px] gap-1'> <Phone  size={15} /><span>+686-654-5335</span></p>
                </div>
      ...
      <div className='bg-[#F0F1F3]'>
              <div className='text-sm text-gray-500 py-4 flex flex-col md:flex-row justify-between items-center container mx-auto px-4 b '>
                ...
                <div className='flex items-center gap-2'> 
                  <Image src="/stripe.png" width={50} height={30} alt="Payment Methods"/>
                  <Image src="/visa.jpg" width={50} height={30} alt="Secure Payment"/>
                  <Image src="/paypal.webp" width={50} height={30} alt="Secure Payment"/>
                </div>
              </div>
      </div>
    </div>
